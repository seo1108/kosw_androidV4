...
//    }
    ...
    private void createAdapter() {
        ...
        mRankingAdapter = new FragmentRankingIndividual.RankingAdapter(mActivity, ranks, this);
    }
...
//        requestRankingToServer();
    ...
    public void performLoadTask(int firstVisibleItemPosition) {
        ...
        Call<PageResponseBase<Ranking>> call = getUserService().getRankingPrivate(query);
